...
void main() {
  ...
  test('setTypeChangesName', () {
    ...
    fleet.setFleetType(ap, FleetType.DEFENSE_FLEET);
    expect(fleet.name, "1");
  });
  ...
  test('setTypeFromRegularToExDontChangeName', () {
    ...
    fleet.setFleetType(ap, FleetType.EXTERMINATION_FLEET_HOME_WORLD);
    expect(fleet.name, "2");

    fleet.setFleetType(ap, FleetType.EXTERMINATION_FLEET_GALACTIC_CAPITAL);
    expect(fleet.name, "2");
  });
